...
while True:
    phone = is_phone(input(f'{g}Enter Phone Number {g}(+98){r}: {w}'))
    if phone:
        break
try:
    Time = float(input(f'{g}Enter Sleep{r}[Defult(0.1)] {w}'))
except ValueError:
    Time = 0.1
